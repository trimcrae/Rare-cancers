...
**[PUB-VACCINE-PATH](L3-publications.md)** — [Toward a fusion-junction vaccine in extraskeletal myxoid chondrosarcoma: a blocker-by-blocker development path](../../research/manuscripts/neoantigen/emc-vaccine-development-path.md)
...
**The paper would claim:** That the obstacles between the EWSR1::NR4A3 junction and a therapeutic vaccine are separable, individually falsifiable and unequally priced, and that the standing negative on this route was reached by grading a vaccine alone. The reasoning that excluded every priming-directed class for this disease turns on antigen supply, which is what a vaccine provides, so the combination of a junction construct with checkpoint blockade on a backbone that also addresses physical exclusion has never been graded as a unit. No efficacy, safety, presentation or immunogenicity claim is made.
