...
| **PUB-ENDPOINT**<br/>[Objective response as a trial summary: the regime in which it carries n…](../../research/manuscripts/response-endpoint-indolent-tumours.md) | ◐ `drafted` | `journal_submission` | 1 | — |
...
### PUB-ENDPOINT — Objective response as a trial summary: the regime in which it carries no information, and the diseases inside it
