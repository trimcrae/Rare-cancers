...
| [RT-MDM2](L2-rt-mdm2.md) — MDM2 antagonism (p53 reactivation in a quiet genome) | `contributing` | A bounded account separating the observed expression pattern from unresolved pharmacologic response; no standalone negative-efficacy claim or publication admission. |
