...
The fusion junction produces a peptide sequence that is absent from the normal proteome, and whether any allele presents it is a prediction that must be regenerated against a corrected exon index before it can be reported at all.
