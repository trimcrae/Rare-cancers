...
|---|---|---|---:|---|
| **PUB-ASO**<br/>[Two junction-spanning gapmer reagents for NR4A3 fusion transcripts in e…](../../research/manuscripts/aso/fusion-junction-aso-journal-article.md) | ◕ `complete_unposted` | `journal_submission` | 2 | — |
...
### PUB-ASO — Two junction-spanning gapmer reagents for NR4A3 fusion transcripts in extraskeletal myxoid chondrosarcoma, selected from 190 designs against a wild-type parent screen that condemns 87
