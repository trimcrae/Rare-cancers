...
| **PUB-VACCINE-PATH**<br/>[Toward a fusion-junction vaccine in extraskeletal myxoid chondrosarcoma…](../../research/manuscripts/neoantigen/emc-vaccine-development-path.md) | ◐ `drafted` | `preprint` | 1 | — |
...
### PUB-VACCINE-PATH — Toward a fusion-junction vaccine in extraskeletal myxoid chondrosarcoma: a blocker-by-blocker development path
