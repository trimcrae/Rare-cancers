...
| **[RT-CHAPERONE](L2-rt-chaperone.md)**<br/>Chaperone dependency of the chimera (HSP90 and co-chaperones) | ✓ blocked | computed | `internal_note` | [PUB-TXN-DEPENDENCY](L3-publications.md) ○ *primary* | Establish whether any FET-family fusion protein is a documented chaperone client. |
...
| **[RT-POLQ](L2-rt-polq.md)**<br/>POLθ inhibition (microhomology-mediated end joining) | ✓ parked | computed | `internal_note` | [PUB-BIOMARKER-DEP](L3-publications.md) ○ *contributing* | Report it beside the DDR assessment's existing weak grade, not apart from it. |
