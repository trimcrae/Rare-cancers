...
| **[RT-VTE-PROPHYLAXIS](L2-rt-vte-prophylaxis.md)**<br/>Venous thromboembolism in a lung-metastatic sarcoma population | ○ ready | concept | `internal_note` | [PUB-MORTALITY-MECHANISM](L3-publications.md) ◐ *contributing* | CORRECTED 2026-09-03: the corpus count is DONE (see supporting_evidence) -- zero true VTE deaths, one tumour-e |
## Best next action
