...
|---:|---|---|---|---:|---:|---:|---:|---:|---|
| 1 | [**PUB-REPURPOSING**](../../research/manuscripts/repurposing-hypotheses.md) | ⭐ could still help a patient | ✅ yes | **16.4** | 2 | 0 | 0 | 1 | ◐ `drafted` |
| 2 | [**PUB-ASO**](../../research/manuscripts/fusion-junction-aso-paper.md) | ⭐ could still help a patient | ✅ yes | **14.2** | 1 | 0 | 0 | 0 | ◐ `drafted` |
| 3 | [**PUB-MTAP-PRMT5**](../../research/manuscripts/emc-mtap-prmt5-hypothesis.md) | ⭐ could still help a patient | ✅ yes | **14.0** | 1 | 0 | 0 | 1 | ◐ `drafted` |
| 4 | [**PUB-SURFACE-TARGETS**](../../research/manuscripts/emc-surface-target-landscape.md) | ⭐ could still help a patient | ✅ yes | **13.5** | 2 | 3 | 0 | 0 | ◐ `drafted` |
| 5 | [**PUB-ATR**](../../research/manuscripts/emc-atr-vulnerability-assessment.md) | ⭐ could still help a patient | ✅ yes | **12.0** | 1 | 0 | 0 | 1 | ◐ `drafted` |
| 6 | [**PUB-ATR-PANEL-ASK**](../../research/manuscripts/emc-atr-collaborator-package.md) | ⭐ could still help a patient | ✅ yes | **11.0** | 0 | 0 | 0 | 0 | ◐ `drafted` |
| 7 | [**PUB-STRATEGY-ARCH**](../../research/manuscripts/emc-trial-reachability.md) | ⭐ could still help a patient | — | **9.6** | 1 | 2 | 0 | 1 | ◐ `drafted` |
| 8 | [**PUB-FUSION-PARTNER**](../../research/manuscripts/emc-fusion-partner-stratification.md) | ⭐ could still help a patient | — | **8.5** | 1 | 0 | 0 | 1 | ◐ `drafted` |
...
| 15 | [**PUB-DEGRADER**](../../research/manuscripts/nr4a3-degrader-paper.md) | ⛔ known negative / methods | — | **15.3** | 2 | 3 | 0 | 2 | ◐ `drafted` |
...
| 24 | [**PUB-NEOANTIGEN**](../../research/manuscripts/fusion-junction-neoantigen-paper.md) | ⛔ known negative / methods | — | **0.7** | 0 | 2 | 0 | 0 | ◐ `drafted` |
| 25 | [**PUB-HLA-COVERAGE**](../../research/manuscripts/hla-coverage-emc.md) | ⛔ known negative / methods | — | **0.0** | 0 | 1 | 0 | 0 | ◐ `drafted` |
| 26 | [**PUB-SYNLETH**](../../research/manuscripts/degrader-vs-synthetic-lethal.md) | ⛔ known negative / methods | — | **0.0** | 0 | 1 | 0 | 0 | ◐ `drafted` |
| 27 | [**PUB-CLOSED-ROUTES**](../../research/manuscripts/closed-routes-negative-record.md) | ⛔ known negative / methods | — | **-6.0** | 0 | 7 | 0 | 0 | ◐ `drafted` |
| 28 | **PUB-PARKED-MODALITIES** | ○ parked on a capability nobody has | — | **-3.0** | 0 | 5 | 0 | 0 | ○ `unwritten` |
...
**PUB-SURFACE-TARGETS** — score 13.5
