...
| **CLM-IDR-EMC** | `research/manuscripts/program/emc-post-degrader-options.md`<br/>route 1's RGG-retention table row for EWSR1::NR4A3 | **ART-IDR-CENSUS** | `/emc_EWSR1_NR4A3_reported_types/EWSR1_NR4A3_type2/rg_dipeptides_retained` |
