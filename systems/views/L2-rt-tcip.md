...
**[PUB-TCIP](L3-publications.md)** — *The induced-interface floor that proximity design inherits from degraders is about twice the interface of the one solved transcriptional CIP* (unwritten)
