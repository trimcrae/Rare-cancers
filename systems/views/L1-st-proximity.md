...
| **[RT-TCIP](L2-rt-tcip.md)**<br/>TCIP — transcriptional chemically-induced proximity on EWSR1::NR4A3 | ○ blocked | scoped | `preprint` | [PUB-TCIP](L3-publications.md) ○ *primary* | Stage a transcriptional-effector second-terminus body (deposited structure + ligand exit atom) via an RCSB fet |
