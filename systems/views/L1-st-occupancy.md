...
| **[RT-NR2F1](L2-rt-nr2f1.md)**<br/>Orphan nuclear-receptor agonism against dormancy escape | ○ blocked | scoped | `internal_note` | [PUB-NR-OUTSIDE-NR4A3](L3-publications.md) ◔ *primary* | Perform a bounded descriptive NR2F1 read in the already-held Hofvander TPM input using retained primary-EMC id |
