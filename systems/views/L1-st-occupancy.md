...
| **[RT-MONOVALENT](L2-rt-monovalent.md)**<br/>Monovalent LBD pocket modulation — a molecule that only OCCUPIES the NR4A3 LBD | ○ blocked | scoped | `internal_note` | [PUB-MONOVALENT](L3-publications.md) ◐ *primary* | Write down the selectivity requirement this route would have to meet, with its basis. It is $0 and it is what  |
