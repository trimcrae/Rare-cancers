...
| **[RT-NR2F1](L2-rt-nr2f1.md)**<br/>Orphan nuclear-receptor agonism against dormancy escape | ○ blocked | concept | `internal_note` | [PUB-NR-OUTSIDE-NR4A3](L3-publications.md) ○ *primary* | Read the receptor in the targeted expression panel already committed here, then state whether the existing poc |
