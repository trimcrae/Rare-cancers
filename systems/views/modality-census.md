...
| **MOD-HYPOXIA-PRODRUG**<br/>Hypoxia-activated prodrugs | evofosfamide | ⭑ `candidate` | ⭑ **new** | EMC is a hypovascular, matrix-dominated tumour, and the repository has already accepted that this makes it a good niche fit when it graded engineered … |
...
| **MOD-NR-ORPHAN-AGONIST**<br/>Orphan nuclear-receptor agonism outside the NR4A family | NR2F1 agonists | ⭑ `candidate` | · | A registered lane with no route. It targets the disease's actual clinical problem -- dormancy and late metastasis -- and it repoints the … |
...
| **MOD-SERM-SERD**<br/>Selective oestrogen-receptor modulators and degraders | tamoxifen | ⭑ `candidate` | · | A 5′ fusion partner can import a druggable transcriptional input that NR4A3 itself does not have, and the repository already holds a reported … |
...
| class | exemplar | verdict | prior | where it lands |
|---|---|---|---|---|
| **MOD-ALK-ROS1**<br/>ALK / ROS1 inhibitors | brigatinib | ⭑ `candidate` | ⭑ **new** | An ALK/ROS1-class inhibitor was among the low-IC50 hits of a 221-drug screen run on a patient-derived EMC line, and nothing here has ever followed it … |
...
| **MOD-DNAPK**<br/>DNA-PK inhibition | peposertib | ⭑ `candidate` | · | A registered lane with no route. Its appeal is structural rather than pharmacological: there is curated experimental evidence of an interaction with … |
...
| **MOD-IGF1R**<br/>IGF-1R inhibitors | teprotumumab | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| **MOD-RET**<br/>RET-selective inhibitors | selpercatinib | ⭑ `candidate` | · | The highest-ranked lane of the 2026-08-07 sweep and still not a route. It is the only kinase reported as both expressed and activated in EMC, the … |
| **MOD-SGK1**<br/>SGK1 inhibition | SGK1 inhibitors | ⭑ `candidate` | · | A registered lane with no route: a druggable AGC kinase reported positive across a full small series of EMC tumours with an internal negative … |
...
| **MOD-TRANSCRIPTIONAL-CDK**<br/>Transcriptional CDK inhibition (CDK7, CDK9, CDK12/13) | CDK7 and CDK9 inhibitors | ⭑ `candidate` | ⭑ **new** | ⭐ The single largest gap this census found in the class it should most obviously have covered. … |
...
| **MOD-EZH2**<br/>EZH2 / PRC2 inhibitors | tazemetostat | ⭑ `candidate` | ⭑ **new** | Approved in a sarcoma selected by a chromatin-remodeller defect, and the portfolio already contains a chromatin-remodelling hypothesis for EMC … |
...
| **MOD-HSP90**<br/>HSP90 and chaperone inhibitors | HSP90 inhibitors | ⭑ `candidate` | ⭑ **new** | ⭐ A structural argument nobody here has made: fusion oncoproteins are chimeric, and chimeric proteins are disproportionately chaperone-dependent for … |
...
| **MOD-POLQ**<br/>POLθ inhibitors | POLQ inhibitors | ⭑ `candidate` | ⭑ **new** | The newest DNA-damage-response class, and the one the existing class-inheritance argument was never extended to. … |
| **MOD-PRMT5-MAT2A**<br/>PRMT5 / MAT2A inhibitors (MTAP-deletion synthetic lethality) | MAT2A inhibitors | ⭑ `candidate` | ⭑ **new** | ⭐ One of the few genuinely biomarker-selected synthetic-lethal classes in oncology, and its biomarker is a copy-number state nobody here has ever … |
...
| **MOD-XPO1**<br/>Nuclear export (XPO1) inhibitors | selinexor | ✕ `already_rejected` | · | already ruled — [emerging-modalities-scan-emc.md](../../research/manuscripts/emerging-modalities-scan-emc.md#5-briefly-considered-lower-priority) |
...
| **MOD-CONDENSATE**<br/>Condensate-partitioning small molecules | condensate-partitioning agents | ✕ `already_rejected` | · | already ruled — [emc-post-degrader-options.md](../../research/manuscripts/emc-post-degrader-options.md#3b--the-technique-classes-searched-and-where-each-landed) |
...
| **MOD-MCL1-BCLXL**<br/>MCL-1 and BCL-xL inhibitors | MCL-1 inhibitors | ⭑ `candidate` | ⭑ **new** | Follows directly from a result the repository already holds and never pursued: BCL-2 inhibition was inactive alone and active only in combination in … |
| **MOD-MDM2-P53**<br/>MDM2 / MDMX antagonists (p53 reactivation) | MDM2 antagonists | ⭑ `candidate` | ⭑ **new** | ⭐ The class needs wild-type p53 and works worst where the genome is chaotic -- and EMC's genome is quiet and clonal with a single founding … |
...
| **MOD-AUTOPHAGY-DEGRADER**<br/>Autophagy-targeting chimeras (AUTAC, ATTEC, AUTOTAC) | ATTECs | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| **MOD-RIBOTAC**<br/>RIBOTAC / RNase-recruiting small molecules | RIBOTACs | ✕ `already_rejected` | · | already ruled — [emc-post-degrader-options.md](../../research/manuscripts/emc-post-degrader-options.md#3b--the-technique-classes-searched-and-where-each-landed) |
...
| **MOD-ONCOLYTIC-BACTERIA**<br/>Oncolytic and engineered bacteria | engineered anaerobes | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
| **MOD-ONCOLYTIC-VIRUS**<br/>Oncolytic viruses | talimogene laherparepvec | ✕ `already_rejected` | · | already ruled — [emerging-modalities-scan-emc.md](../../research/manuscripts/emerging-modalities-scan-emc.md#5-briefly-considered-lower-priority) |
...
| **MOD-AOC**<br/>Antibody-oligonucleotide conjugates | antibody-oligonucleotide conjugates | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| **MOD-IMMUNOCYTOKINE**<br/>Immunocytokines (tumour-targeted cytokine fusions) | antibody-cytokine fusions | ⭑ `candidate` | ⭑ **new** | ⭐ The one antibody format whose address is not a tumour-cell antigen. It targets an extracellular matrix epitope, and the matrix is EMC's defining … |
...
| **MOD-CAR-M**<br/>CAR-macrophages | CAR-macrophages | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| **MOD-IN-VIVO-CAR-T**<br/>In vivo CAR-T | in vivo CAR-T | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| **MOD-TIL**<br/>Tumour-infiltrating lymphocyte therapy | TIL therapy | ✕ `already_rejected` | · | already ruled — [emerging-modalities-scan-emc.md](../../research/manuscripts/emerging-modalities-scan-emc.md#5-briefly-considered-lower-priority) |
...
| **MOD-CS-BIOSYNTHESIS**<br/>Inhibition of tumour glycosaminoglycan biosynthesis | glycosaminoglycan synthesis inhibitors | ⭑ `candidate` | ⭑ **new** | ⭐ The matrix has been treated here as a barrier and, once, as an address. This is the third option nobody has considered: stop the tumour building … |
...
| **MOD-OFCS-VAR2CSA**<br/>Oncofetal chondroitin sulfate targeting | VAR2CSA-based conjugates | ⭑ `candidate` | · | A registered lane with no route, and the best-argued matrix address the sweep found: it turns EMC's defining glycan into the target, and it belongs … |
| **MOD-STROMAL-NORMALISATION**<br/>Stromal normalisation (LOX / LOXL2, FAK, angiotensin axis) | simtuzumab | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| class | exemplar | verdict | prior | where it lands |
|---|---|---|---|---|
| **MOD-ARGININE-DEPRIVATION**<br/>Arginine deprivation | pegylated arginine deiminase | ⭑ `candidate` | ⭑ **new** | ⭐ A metabolic class that is genuinely biomarker-selected rather than proliferation-coupled: it works where a single biosynthetic enzyme is silenced, … |
...
| **MOD-BRACHYTHERAPY**<br/>Brachytherapy | interstitial brachytherapy | ⭑ `candidate` | ⭑ **new** | Delivers a high conformal dose from inside the tumour bed and has a specific extremity soft-tissue sarcoma history, which matches where EMC actually … |
...
| **MOD-PARTICLE-THERAPY**<br/>Proton and carbon-ion therapy | carbon-ion radiotherapy | ⭑ `candidate` | ⭑ **new** | ⭐ Carbon ions deposit a different quality of dose, and the classical indication is exactly the unresectable radioresistant sarcoma. … |
...
| **MOD-RADIOSENSITIZER**<br/>Radiosensitizers | concurrent chemoradiotherapy | ⭑ `candidate` | ⭑ **new** | The one EMC report of a striking response in the literature is a combination of radiotherapy with a systemic agent, and the repository already … |
...
| **MOD-HYPERTHERMIA**<br/>Regional hyperthermia | regional hyperthermia | ⭑ `candidate` | ⭑ **new** | One of the few physical modalities with randomised evidence in soft-tissue sarcoma specifically, added to systemic therapy rather than replacing it. … |
| **MOD-ILP**<br/>Isolated limb perfusion | TNF-α plus melphalan perfusion | ⭑ `candidate` | ⭑ **new** | ⭐ A regional technique with an approved agent and an established role in unresectable extremity soft-tissue sarcoma -- and this disease's most common … |
| **MOD-INHALED-CHEMO**<br/>Inhaled and aerosolised cytotoxic therapy | inhaled cytotoxics | ⭑ `candidate` | ⭑ **new** | The same lung-predominant argument as regional perfusion, in a repeatable outpatient format rather than a surgical one -- which matters far more for … |
| **MOD-ISOLATED-LUNG-PERFUSION**<br/>Isolated lung perfusion and regional pulmonary delivery | isolated lung perfusion | ⭑ `candidate` | ⭑ **new** | ⭐ EMC's metastatic pattern is lung-predominant and its course is indolent, which is the profile regional pulmonary delivery was developed for: high … |
...
| **MOD-THERMAL-ABLATION**<br/>Percutaneous ablation (radiofrequency, microwave, cryo, focused ultrasound) | percutaneous cryoablation | ⭑ `candidate` | ⭑ **new** | Oligometastatic lung disease is the standard indication for percutaneous ablation, and the curated record for this disease states both that distant … |
...
| **MOD-HERV-DARK-ANTIGEN**<br/>Endogenous retroviral and repeat-derived antigens | HERV-derived epitopes | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| **MOD-SCLEROMYXEDEMA-PHARM**<br/>Pharmacology borrowed from mucin-depositing non-cancer disease | IVIG, immunomodulatory imides | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
| **MOD-SENOLYTIC**<br/>Senolytics and pro-senescence therapy | dasatinib plus quercetin | ✕ `already_rejected` | · | already ruled — [emc-unexplored-treatment-lanes.md](../../research/manuscripts/emc-unexplored-treatment-lanes.md#6--considered-and-rejected) |
...
| class | exemplar | verdict | prior | where it lands |
|---|---|---|---|---|
| **MOD-ADAPTIVE-SCHEDULING**<br/>Adaptive and evolution-guided dosing | adaptive pazopanib scheduling | ⭑ `candidate` | · | A registered lane with no route. It asks nothing new of chemistry and everything of scheduling, it costs nothing, and the sweep found EMC close to an … |
| **MOD-BASKET-ELIGIBILITY**<br/>Biomarker-defined basket eligibility | FET-fusion basket eligibility | ⭑ `candidate` | · | A registered lane with no route, and the sweep's finding is structural rather than scientific: an open trial defines eligibility by a fusion family … |
...
| **MOD-EXPANDED-ACCESS**<br/>Expanded access, compassionate use and off-label registries | single-patient expanded access | ⭑ `candidate` | ⭑ **new** | For a disease that will never have a randomised trial, the realistic route from a computational hypothesis to a treated patient runs through … |
| **MOD-METRONOMIC**<br/>Metronomic dosing | metronomic chemotherapy | ⭑ `candidate` | ⭑ **new** | Continuous low-dose scheduling suits a disease measured in years, where tolerability over time matters more than depth of response -- and it is the … |
...
| **MOD-SEQUENCING**<br/>Treatment sequencing and line ordering | line-of-therapy ordering | ⭑ `candidate` | ⭑ **new** | The registry curates several agents with EMC-specific activity and says nothing about what order to give them in. … |
