...
| **MOD-PRMT5-MAT2A** — PRMT5 / MAT2A inhibitors (MTAP-deletion synthetic lethality) | `enzyme_inhibitor_non_kinase` | ⭑ `candidate` | ◐ PARTLY TAKEN 2026-08-09 and it became a written paper. The two readable series were read and the hypothesis is drafted with its falsifiers. The FOURTH cohort named here was not read; the decisive step is now a stain, not a lookup. |
