...
- How many published EMC series print a numbers-at-risk table at all — ANSWERED for the reachable candidate set on 2026-08-25 by looking at the graphics: 2 of the 5 reachable papers, and both are the smallest cohorts. It is NOT answered for the closed-access series (drilon2008, bishop2019) or for series with no PMC identifier, which is where the remaining count lives.
