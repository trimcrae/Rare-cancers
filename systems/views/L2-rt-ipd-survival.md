...
**Family:** [ST-CARE-DELIVERY](L1-st-care-delivery.md) · **state:** ○ ready · computed · confidence low · verified 2026-08-09
...
**Missing:**
- curves that can actually be reconstructed — only 19 of 340 EMC full texts in the open-access corpus print a Kaplan-Meier curve at all, and how many of those carry a numbers-at-risk table is unmeasured because the table is usually inside the figure image
