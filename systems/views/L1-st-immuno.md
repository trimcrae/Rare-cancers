...
| **[RT-JUNCTION-NEOANTIGEN](L2-rt-junction-neoantigen.md)**<br/>Fusion-junction neoantigen (the antigen, shared by three delivery routes) | ✓ blocked | computed | `internal_note` | [PUB-NEOANTIGEN](L3-publications.md) ◐ *primary* | Regenerate patient-cd4-demo.json and the TAF15 panel at the corrected junction, then re-grade the route on COV |
