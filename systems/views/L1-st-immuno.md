...
| **[RT-TCRT-CTA](L2-rt-tcrt-cta.md)**<br/>TCR-T / engineered T cells vs a cancer-testis antigen (synovial-sarcoma port) | ✓ parked | computed | `internal_note` | [PUB-SURFACE-TARGETS](L3-publications.md) ◐ *contributing* | Keep registered for automatic re-grade when EMC expression data lands. ⛔ CORRECTED 2026-09-02 (AUT-PD-116): th |
