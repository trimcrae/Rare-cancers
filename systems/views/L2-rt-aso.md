...
| Screen the remaining emittable junctions -- TCF12 and the other 22 -- now that the pipeline reaches any partner (aso-offtarget.yml, DONOR:donorExon:NR4A3exon) | ⛔ none built | yes | — |
