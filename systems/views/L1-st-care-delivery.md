...
|---|---|---|---|---|---|
| **[RT-DIAGNOSTIC-PATHWAY](L2-rt-diagnostic-pathway.md)**<br/>The diagnosis itself — code contamination and a name that misleads | ○ ready | computed | `preprint` | [PUB-EMC-CLASSIFICATION](L3-publications.md) ◐ *contributing* | ⭐ DRAFTED 2026-08-23 on trimcrae's decision to publish without the magnitude: research/manuscripts/care-delive |
