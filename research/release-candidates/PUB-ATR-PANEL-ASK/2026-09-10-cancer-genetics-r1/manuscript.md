...
**Table 5 presents the manuscript prediction set alongside the pinned prediction records.**
...
`depmap-dependency.yml` in the public repository, and the original-study-scope wrapper in section 2.5 re-derives it offline.
