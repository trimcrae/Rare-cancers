...
def markdown(doc,content,supp=False):
    ...
    while i<len(lines):
        ...
        if line.startswith('## '):
            ...
            abstract=title=='Abstract';references=title=='References'
