...
for doc in sorted((W/'journal-package').glob('CSPG4-manuscript.docx')):
    ...
    whole=''.join(re.sub(r'CSPG4 RNA across sarcoma types\s*\|\s*\d+','',s) for s in texts);whole=norm(whole)
