...
panels=[('PRIMARY CATALOGUE',['38 modelled exon-3 joins','190 junction-spanning','16-nucleotide designs']),('ONE-BASE REGISTER SHIFT',['TAF15 e6::NR4A3 e3','Centred: 9 bp (TFG)','Adjacent: 11 bp (NR4A3)']),('ADOPTED 10-bp CRITERION',['Primary designs: 45.8%','Artificial joins: 40.6%','No EMC-specific excess'])]
