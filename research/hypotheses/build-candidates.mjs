...
const CANDIDATES = [
  ...
  { id: "pioglitazone-pparg", drug: "Pioglitazone (and other PPARγ agonists)", drugClass: "PPARγ agonist (thiazolidinedione)", regulatoryStatus: "FDA/EMA-approved (type 2 diabetes)", notTriedInEmc: true,
    ...
    supportingEvidence: [
      { claim: "Zaltoprofen's anti-EMC effect was mediated by PPARγ induction, implicating PPARγ agonism as the actionable node.", context: "EMC (mechanistic)", sourceId: "zaltoprofen2023" } ],
    rationale: "If PPARγ induction drives the anti-EMC effect, a direct, approved PPARγ agonist (pioglitazone) is an obvious low-toxicity test — untried in EMC.",
    evidenceTier: "T1-preclinical-or-analog", speculationLevel: "moderate",
