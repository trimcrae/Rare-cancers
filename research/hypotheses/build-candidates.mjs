...
const CANDIDATES = [
  ...
  { id: "vegfr-tki-extension", drug: "Regorafenib / cabozantinib / lenvatinib", drugClass: "anti-angiogenic multikinase (VEGFR) TKI", regulatoryStatus: "FDA/EMA-approved (other indications)", notTriedInEmc: true,
