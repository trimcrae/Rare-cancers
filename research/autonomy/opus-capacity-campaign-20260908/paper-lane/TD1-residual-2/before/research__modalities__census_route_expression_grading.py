...
def build():
    ...
    routes["RT-TXN-CDK"] = {
        ...
        "observed": ("The CDK7 initiation module and the general transcriptional-output group both read "
                     "HIGHER in EMC on both platform records, at nominal uncorrected significance. The "
                     "CDK9 elongation module is higher on both but weakly. MYC is up on both. ⚠ Corrected "
                     "2026-09-08 (TD1 final review, root adjudication) F7: \"both with the largest "
                     "t-statistics in this pass\" is withdrawn — no reproducible, scientifically meaningful "
                     "census-wide ranking criterion was defined for it. ⚠ F2: the GPL3290 record is under "
                     "an interpretation hold, its deposited reference labels differing by group (CRH-mRNA "
                     "for the EMC arm, CRH for DFSP, UHR for GIST) with comparability across them not "
                     "established."),
        "verdict": ("SUPPORTED ON ABUNDANCE, EXPLORATORY — elevated on both platform records, uncorrected "
                    "for multiple testing. ⚠ Corrected 2026-09-08 (TD1 final review, root adjudication) "
                    "F7: the superlative \"the most concordant elevation in the census\" is withdrawn as an "
                    "undefined rank; F2: the GPL3290 record is under an interpretation hold."),
        ...
        "the_dependency_screen_ran_and_it_closed_the_window": ("⚠ Corrected 2026-09-08 (TD1 final review, root adjudication) F1/F3: THE DEPENDENCY "
                                                               "SCREEN DID NOT CLOSE THIS WINDOW, and the earlier text under this field name is "
                                                               "superseded (the key itself is retained unchanged for consumer stability). What is "
                                                               "measured: across the 91 screened sarcoma-lineage lines (of 176 catalogued Soft "
                                                               "Tissue/Bone models) in DepMap 24Q4, CDK7 and CDK9 have Chronos gene effects below "
                                                               "the -0.5 dependency threshold in 100% of them, with mean gene effects of -1.85 and "
                                                               "-1.46 and cancer-line mean differences (non-sarcoma minus sarcoma) of +0.085 and "
                                                               "+0.017 reported without a precision estimate. ⛔ That is a broad binary dependency in "
                                                               "NON-EMC cancer lines. It does not establish equal continuous effects, absence of "
                                                               "subgroup heterogeneity, absence of a graded response to partial inhibition, absence "
                                                               "of a selectable phenotype, or a tumour-versus-normal window — a cancer-versus-cancer "
                                                               "comparison cannot supply one. No line here contributes a CRISPR observation for EMC, "
                                                               "so nothing in it decides an EMC-specific dependency, and the expression and "
                                                               "dependency readings are UNPAIRED: no relationship between them is estimated."),
    ...
    routes["RT-CHAPERONE"] = {
        ...
        "observed": ("The HSP90 machine reads HIGHER in EMC on both platform records and the co-chaperones "
                     "follow it in direction, the co-chaperone contrasts not reaching nominal "
                     "significance. ⚠ The HSP70-arm-and-heat-shock group gives negative point estimates on "
                     "both, NEITHER distinguishable from zero and both with approximate intervals that "
                     "include positive differences. ⚠ Corrected 2026-09-08 (TD1 final review, root "
                     "adjudication) F4: \"go the OTHER way on both, which is not what a general stress "
                     "response looks like\" is withdrawn. This is no clear evidence of a positive contrast "
                     "for this curated list — not absence of elevation, not an equivalence result, and not "
                     "contradictory biology."),
        "verdict": ("PARTLY SUPPORTED, EXPLORATORY — the HSP90 arm only; the stress-response arm gives no "
                    "clear evidence in either direction. ⚠ Corrected 2026-09-08 (TD1 final review, root "
