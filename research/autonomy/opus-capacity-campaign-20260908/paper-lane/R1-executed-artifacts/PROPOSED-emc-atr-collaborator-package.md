<!-- ============================================================================
PROPOSED CANDIDATE REVISION - R1 lane, 2026-09-08. NOT A RECOVERED ORIGINAL.

This file is a PROPOSED reconstruction built by applying, to the committed
pre-revision manuscript, only those corrections that a COMMITTED input settles:
  research/modalities/emc-fet-frame-and-composition.json
  research/modalities/tests/test_emc_fet_frame_and_composition.py (line 32)
  research/manuscripts/dependency/emc-atr-collaborator-package-changelog.md
No wording has been recovered from the 2026-08-10 revision. Where the changelog
states a "current" wording it has been used as a specification, not as a quotation.
Items this file does NOT apply are listed as DECISIONS and as UNRESOLVED in
DECISION-MEMO.md in the same directory. Do not treat this as submission-ready.
============================================================================= -->
...
encode 59 residues that this programme's own earlier protein-level model did not contain. Type 1 is the commonest reported type in every
...
comparator span of 0.000 to 0.267 for EWSR1::ATF1 and firmly measured positions at 0.000 and 1.000. TCF12, the 5' partner in a minority of EMC, falls outside
...
|---|---|---|---|
| EWSR1::NR4A3 type 1 | EWSR1 e12 to NR4A3 e3 | commonest in every series that types its cases: 10 of 15 [7], 11 of 15 [9] | [4,5,6]; expressed as "E-N, corresponding to EWSR1 (exons 1-12)-NR4A3 (exons 3-8)" [3] |
| EWSR1::NR4A3 type 2 | EWSR1 e7 to NR4A3 e2 | minority variant, counted once across three counted series: 1 of 15 [9], absent from the counted types of [7] | [4,6] |
| EWSR1::NR4A3 type 5 | EWSR1 e13 to NR4A3 e3 | named second commonest in [7], 2 of 15 | [5,7] |
| TAF15::NR4A3 | TAF15 e6 to NR4A3 e3 | the only reported coding junction; 3 of 15 [9], 4 of 10 [10] | [4,5,7]; expressed as "T-N*, corresponding to the commonest TAF15 (exons 1-6)-NR4A3 (exons 3-8) fusion" [3] |
...
methionine, and the chimeric open reading frame is 949 aa. The type-2 fusion protein predicted by the canonical transcripts is
...
|---|---|---|
| P1 | EWSR1::NR4A3 type 2 is recruited to laser-induced breaks with kinetics indistinguishable from EWSR1-FLI1. Basis: 0 of 30 RG retained, on a segment identical in sequence to the reference construct's | no accumulation at the stripe, or kinetics matching native EWSR1 rather than the fusion reference |
...
| P3 | TAF15::NR4A3 is recruited, at the zero end of the axis. Basis: TAF15(1-161) retains 0 of 31, with 13 residues of headroom below the RG-free ceiling of 174 and TAF15's first RG at 175 | kinetics indistinguishable from native TAF15 |
...
| P5 | TCF12::NR4A3 is not recruited, behaving like reference 1's full-length FLI1 control, which "showed no accumulation at laser-induced DSBs" [1] | recruitment of TCF12::NR4A3 |
