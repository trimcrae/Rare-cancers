...
- **`[x]` Validation B-mini — all-binding graded cooperativity edge** — **~$8.8 ($3.2–22) · Cum. ~$13.** The Wurz ⚠ MARKER CORRECTED 2026-08-06 against the roadmap, which owns a gate's verdict: the roadmap's scoreboard records this gate FAILED (wrong sign, provably not fixable by more replicates).
...
- **`[x]` Rung 2b — 4 fs adoption + matched re-calibration** — **~$4.4 ($1.6–11) · Cum. ~$17 · PROPOSED, needs a ⚠ MARKER CORRECTED 2026-08-06 against the roadmap, which owns a gate's verdict: the roadmap's scoreboard records it PASSED — both stages.
...
- **`[ ]` Validation B-full — component-calibration cube** — **~$22.5 ($6–67) · Cum. ~$40.** ★ **Module 3
  ...
  modules pass.
- **`[x]` NR-V04 covalent feasibility panel — ⚠ RESULT UNDER CORRECTION; ITS **GO** DOES NOT STAND** — ⚠ MARKER CORRECTED 2026-08-06 against the roadmap, which owns a gate's verdict: WITHDRAWN — the roadmap records the verdict as withdrawn in full, which is a closed state, not one under correction.
...
- **`[x]` Step 1 fan-out — cmpd19 congeneric map** — **~$36 ($15–80; ≈19 RBFE edges × ~13.7 ref GPU-h) · ⚠ MARKER CORRECTED 2026-08-06 against the roadmap, which owns a gate's verdict: the lane CLOSED itself 2026-07-29; step1-fanout-map.json n_complete 18 of 19 computable, $73.79.
...
- **`[x]` NR-V04 retrospective — preregistered holdout** — **~$21 ($4.8–67) · Cum. ~$104.** Full ensembles ⚠ MARKER CORRECTED 2026-08-06 against the roadmap, which owns a gate's verdict: RAN and returned DISCORDANT (nrv04-retro-verdict.json, panel_complete true).
...
- **`[x]` 5a-KS · Wedge confirmation — pilot-first KILL-SWITCH + causal RESULT** — **~$23 ($3.1–97) · Cum. ~$152.** ⚠ MARKER CORRECTED 2026-08-06 against the roadmap, which owns a gate's verdict: LANDED 2026-08-02 — nr4a3-5aks-reduction.json carries the preregistered null S = -0.13 +/- 0.33.
...
- **`[x]` 5b · Inverse linker design — DONE 2026-07-25, $0 REALIZED (1,995 enumerated → 54 retained (36 exemplar + 18 representative), RDKit-verified 54/54 ⚠ *superseded, retained: "21 retained, RDKit-verified 21/21" — pinned-figures.json registers linker_library_21_constructs as SUPERSEDED, and nr4a3-linker-design.json gives 36 + 18 = 54*)** — **~$0–20 (mostly $0 CPU) · Cum. ~$162.** For each confirmed basin, derive
