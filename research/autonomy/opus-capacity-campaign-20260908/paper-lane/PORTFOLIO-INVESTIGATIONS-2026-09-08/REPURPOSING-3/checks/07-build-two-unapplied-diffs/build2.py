...
sub("""| PPARγ agonism with pioglitazone, motivated by zaltoprofen | untried; targets EMC lineage""",
"""| PPARγ agonism with pioglitazone, motivated by zaltoprofen | untried in EMC, although zaltoprofen itself has been given to one chondrosarcoma patient [23]; targets EMC lineage""","Z3 tranche table untried column")
...
open("/tmp/claude-0/-home-user-Rare-cancers/8ecd0f49-96ba-5dcf-b11a-af5e48bdec71/scratchpad/rep3/AFTER2.md","w",encoding="utf-8").write(t)
