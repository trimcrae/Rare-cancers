...
### Additional free copies and source limits

An OpenAlex audit of 423 unresolved DOIs returned 89 possible public-copy locations. These are candidates, not verified free documents; metadata-only pages remain unresolved. Verified documents are linked individually, with reading extent recorded separately.

The [Angelucci multimodal case](https://doi.org/10.52768/2379-1039/2159) reports pathological response after three preoperative modalities and surgery. It cannot isolate hyperthermia benefit. Its timeline and response-label discrepancies are retained. The [Warsaw two-case report](https://doi.org/10.5603/ocp.108816) also distinguishes planned from administered treatment inconsistently; the catalogue preserves the case histories rather than inferring an unreported targeted-therapy outcome.

The [cemiplimab case](https://doi.org/10.1634/theoncologist.2017-0344) includes both tumor shrinkage and fatal encephalitis. Main text, references, the main figure and both supplementary figures were read. Its [probable earlier autopsy abstract](https://doi.org/10.1093/ajcp/aqw162.013) is a separate output, not established additional enrollment. This previously published immune hypothesis does not establish a safe new treatment lead.
