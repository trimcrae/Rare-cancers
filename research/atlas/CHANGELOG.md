# EMC Atlas — CHANGELOG (historical progress notes)

> Moved out of STATUS.md per reviewer must-fix #13 (STATUS.md is now a single dated snapshot).
> These are the dated development notes; treat the latest STATUS.md as authoritative for current state.
