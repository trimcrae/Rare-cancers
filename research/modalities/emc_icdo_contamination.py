...
# ---------------------------------------------------------------------------
SIZE = {
    "state": "NOT_MEASURED -- and the reason is now specific rather than general",
    "the_question": "Of a registry cohort selected on morphology 9231/3, what fraction has a bone "
    "primary?",
    "why_it_is_still_open": "Four SEER cohorts selected on this code are published. NONE of them "
    "prints a bone-versus-soft-tissue split, and the reason differs per paper: PMID 31765367 has "
    "a location variable with no soft-tissue category at all; PMID 32856598 almost certainly has "
    "the table and is a subscription article this project cannot read at $0; PMID 27819877 "
    "applied the topography restriction but publishes only the post-restriction count; PMID "
    "35144048 stratifies by anatomic site but its categories are unread.",
    "the_closest_published_numbers_and_what_each_is_not": [
        {
            "number": "791 identified on morphology 9231/3, 439 after exclusions (SEER "
            "1973-2016, PMID 32856598)",
            "what_it_is_not": "⛔ NOT a contamination fraction. Nobody has read what the 352 "
            "exclusions were for. Dividing them would be the manufactured ratio the registration "
            "forbids.",
            "provenance": "[2°] via PMC12504171",
        },
        {
            "number": "87 of 743 (11.7%) high-grade SEER chondrosarcoma cases carry morphology "
            "9231 (SEER 1973-2014, PMID 31765367)",
            "what_it_is_not": "⛔ NOT the bone-primary fraction of a 9231/3 cohort. It is the "
            "converse -- how much 9231 sits inside a bone-FRAMED cohort -- and it is restricted "
            "to high grade, which EMC often is not.",
            "provenance": "[FT]",
        },
    ],
    "what_would_close_it_now_ranked": [
        ...
        "blocked on BLK-REGISTRY-DUA, and the highest-value next step is a PDF, not a DUA.",
        "The Methods of PMID 27819877, if they report what the soft-tissue restriction removed.",
        "The anatomic-site table of PMID 35144048.",
        "A SEER Research (base tier) query, which is now measured as needing an institutional "
        "email, an application form and a DUA -- and which carries the topography field.",
    ],
    "provenance": "[DOC] + [FT] + [2°], per row above",
}
