...
Merged 4:50 AM ET Sun Aug 2, 2026. One row per GPU leg, for every lane that can bill.
...
_As of 4:50 AM ET Sun Aug 2, 2026 (1 min ago). Written by `ternary_vast_launch.py task=collect`._
...
_As of 4:50 AM ET Sun Aug 2, 2026 (0 min ago). Written by `congeneric_fanout_vast.py MONITOR=1`. 18 of 19 unit(s) landed; 1 permanently excluded (rows below are the rest)._
...
_As of 4:50 AM ET Sun Aug 2, 2026 (0 min ago). Written by `nrv04_vast_launch.py RETRO_COLLECT=1`. 16 of 16 authorized R1 leg(s) landed (rows below are the rest). ⛔ 2 further record(s) exist but are NOT landed legs (mode='smoke', not 'run') — they do not count toward the panel and cannot reach the frozen gate._
...
zaienne_cmpd19__cw_ms_free_acid r1       5:23 AM            54.2%  — free GCP trial credit (separate ledger) RUNNING           GCE L4, RUNNING, created 2026-08-01T05:37:11.159-07:00. phase='leg-solvent-running 2026-08-02T08:38:40Z'. 2600 of 4800 committed iterations (unit = 2 legs x (warmup 400 + production 2000)). ETA is for the unit — every remaining leg has its own measured rate; 2200 iterations left.. [0 min since the last commit against a budget of 3 x its own measured 0.4 min commit interval] Bounded at CREATE by --max-run-duration=172800s.
