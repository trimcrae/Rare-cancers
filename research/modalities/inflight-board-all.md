...
Merged 12:07 PM ET Fri Jul 31, 2026. One row per GPU leg, for every lane that can bill.
...
_As of 12:00 PM ET Fri Jul 31, 2026 (8 min ago). Written by `ternary_vast_launch.py task=collect`._

```
LEG                ETA (ET)          % DONE  $/ns                               STATE     WHY (when not running)
----------------------------------------------------------------------------------------------------------------
5aks_d0_to_d terna 2:50 PM            78.9%  RTX 5090 $0.00512/ns · 1.50× basis RUNNING   
5aks_d0_to_d terna 9:36 PM            30.2%  RTX 5090 $0.00512/ns · 1.50× basis RUNNING   
5aks_d0_to_d terna —                      —  RTX 3090 $0.00582/ns · 1.71× basis STARTING  targets not in the retained log window — %% and ETA unknowable this pass
...
_As of 11:51 AM ET Fri Jul 31, 2026 — **16 min ago, STALE (> 15 min)**. Written by `congeneric_fanout_vast.py MONITOR=1`. 18 of 19 unit(s) landed; 1 permanently excluded (rows below are the rest)._
...
_As of 12:07 PM ET Fri Jul 31, 2026 (0 min ago). Written by `nrv04_vast_launch.py RETRO_COLLECT=1`. 1 of 18 authorized R1 leg(s) landed (rows below are the rest). ⛔ 17 further record(s) exist but are NOT landed legs (mode='smoke', not 'run') — they do not count toward the panel and cannot reach the frozen gate._
