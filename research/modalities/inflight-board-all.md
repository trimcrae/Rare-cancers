...
Merged 12:32 PM ET Fri Jul 31, 2026. One row per GPU leg, for every lane that can bill.
...
_As of 12:30 PM ET Fri Jul 31, 2026 (3 min ago). Written by `ternary_vast_launch.py task=collect`._

```
LEG                ETA (ET)          % DONE  $/ns                               STATE     WHY (when not running)
----------------------------------------------------------------------------------------------------------------
5aks_d0_to_d terna 2:53 PM            82.2%  RTX 5090 $0.00512/ns · 1.50× basis RUNNING   
5aks_d0_to_d terna 4:10 AM Aug 1      40.9%  RTX 3090 $0.00582/ns · 1.71× basis STARTING  WATCHING — quiet but alive: run.log 2 min old, content changing (last change 0 min ago), GPU idle, no committed advance — consistent with a CPU-bound setup phase
5aks_d0_to_d terna —                      —  RTX 3090 $0.00483/ns · 1.42× basis STARTING  targets not in the retained log window — %% and ETA unknowable this pass
...
_As of 12:32 PM ET Fri Jul 31, 2026 (0 min ago). Written by `congeneric_fanout_vast.py MONITOR=1`. 18 of 19 unit(s) landed; 1 permanently excluded (rows below are the rest)._
...
_As of 12:24 PM ET Fri Jul 31, 2026 (8 min ago). Written by `nrv04_vast_launch.py RETRO_COLLECT=1`. 1 of 18 authorized R1 leg(s) landed (rows below are the rest). ⛔ 17 further record(s) exist but are NOT landed legs (mode='smoke', not 'run') — they do not count toward the panel and cannot reach the frozen gate._
