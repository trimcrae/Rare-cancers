...
def build():
    ...
    return {
        ...
        "_answers": ("research/manuscripts/program/path-family-synthesis.md §2 Tier-1 row 3; routes into roadmap §8 "
...
def to_markdown(a):
    ...
    W("")
    W("*Tier-1 row 3 of [`path-family-synthesis.md`](../manuscripts/program/path-family-synthesis.md) §2, executed.*")
