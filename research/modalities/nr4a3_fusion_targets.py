    ...
    return {
        ...
        "1b_no_fusion_cistrome_exists_in_the_retrieved_literature": {
            ...
            "result": "ZERO. Not one sentence in 2,276 retrieved documents applies a genome-wide "
                      ...
                      "genome-wide map.",
            "⚠_the_absence_this_was_read_as_is_RETRACTED_2026_08_08": (
                "EVERY COUNT ABOVE IS UNCHANGED AND WAS NEVER WRONG. What is retracted is the "
                "INFERENCE from this literature screen to an absence. A wider search on "
                "2026-08-08 — the primary sequence archives rather than retrieved full text — "
                "found a genome-wide chromatin experiment performed with NR4A3 fusions: GEO "
                "GSE243553 (PMID 39048711), a pooled single-cell ATAC screen in HEK293T whose "
                "116-member library carries EWSR1-NR4A3, TAF15-NR4A3, TCF12-NR4A3 and "
                "TFG-NR4A3 with full-length wild-type NR4A3 and the reciprocal NR4A3-EWSR1 as "
                "controls. This screen could not reach it because the paper's title and "
                "abstract say only '>100 oncofusions' and name NR4A3 nowhere, and because in a "
                "pooled screen the perturbation identity is data rather than metadata. ⛔ It is "
                "ACCESSIBILITY and not occupancy, HEK293T and not EMC, so the cistrome question "
                "below is unaffected and GSE243553 may never be cited as a fusion cistrome. The "
                "claim that replaces the retracted one: NO EXPERIMENT HAS MEASURED WHERE AN "
                ...
                "drawn from a current artifact, and this sandbox cannot run the generator. Nothing "
                "in the committed artifact is false — its `result` is explicitly scoped to the "
                "2,276-document corpus — and this line lands there on the next regeneration, which "
                "must re-run nr4a3_fusion_targets_figures.py in the same pass."),
