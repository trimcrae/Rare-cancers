...
KNOWN_HAND_ROLLED: set[tuple[str, str]] = {
    ...
    ("fusion-cpu-extras.yml", "energy_probe"),
    ("fusion-cpu-extras.yml", "lane7_anchor_diag"),
    ("fusion-cpu-extras.yml", "lane7_native_arm"),
    ("fusion-cpu-extras.yml", "map_audit"),
    ("fusion-cpu-extras.yml", "map_diag"),
    ("fusion-cpu-extras.yml", "nr4a_basin_search"),
    ("fusion-cpu-extras.yml", "nr4a_e3_stage"),
    ("fusion-cpu-extras.yml", "nr4a_e3_widened"),
    ...
    ("fusion-cpu-extras.yml", "nrv04_retro_price_forensics"),
    ("fusion-cpu-extras.yml", "nrv04_retro_secondaries"),
    ("fusion-cpu-extras.yml", "nrv04_s3_tail"),
    ("fusion-cpu-extras.yml", "nrv04_vast_launch"),
    ("fusion-cpu-extras.yml", "run"),
    ("fusion-cpu-extras.yml", "s1f_liveness"),
    ("fusion-cpu-extras.yml", "s_calibrator_survey"),
    ("fusion-cpu-extras.yml", "step1_fanout"),
    ("fusion-cpu-extras.yml", "vast_bid_advise"),
    ...
    ("gpu-ternary-fep-vast.yml", "blacklist_clear"),
    ("gpu-ternary-fep-vast.yml", "charge_provenance"),
    ...
    ("gpu-ternary-fep-vast.yml", "prime_5aks"),
    ("gpu-ternary-fep-vast.yml", "reduce"),
    ("gpu-ternary-fep-vast.yml", "reduce_5aks"),
    ("gpu-ternary-fep-vast.yml", "reps_diag"),
    ("gpu-ternary-fep-vast.yml", "reps_prime"),
    ("gpu-ternary-fep-vast.yml", "reps_setup_rss"),
    ("gpu-ternary-fep-vast.yml", "triangle_diag"),
    ("gpu-ternary-fep-vast.yml", "triangle_freeze"),
    ("gpu-ternary-fep-vast.yml", "triangle_gate"),
    ("gpu-ternary-fep-vast.yml", "triangle_prime"),
    ("gpu-ternary-fep-vast.yml", "triangle_reduce"),
