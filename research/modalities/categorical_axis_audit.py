...
def pose_split(dyn, reach, uniq, basins):
    ...
    return {
        ...
        "pocket_dependent_but_NOT_docked_pose_dependent": {
            ...
            "what_this_actually_inherits_from_V3": "V3's failure was SITE SELECTION on 6 of 6 pairs — and now "
                                                   "0 of 14 IN REGIME by two independent transfer "
                                                   "routes, against 11 of 14 for an fpocket-chosen box "
                                                   "— not pose accuracy: with an fpocket-chosen box the "
                                                   "same protocol lands in C14's PARTIAL band. (The "
                                                   "RMSD digit is deliberately not restated: the arm is "
                                                   "an unseeded Monte-Carlo search whose value has been "
                                                   "committed six different ways; C6 measured the BAND "
                                                   "to be what is stable.) Site selection is exactly "
        ...
        "research/manuscripts/nr4a3-program-map.md": [
            ...
            },
            {
                ...
                "proposed_text": "Everything here is conditional on **the cryptic pocket being the right "
                                 ...
                                 "`V3`: V3's failure was **site selection** on 6 of 6 pairs — and now "
                                 "**0 of 14 in regime by two independent transfer routes**, against "
                                 "**11 of 14** for an fpocket-chosen box — not pose accuracy (an "
                                 "fpocket-chosen box lands in `C14`'s PARTIAL band; the RMSD digit is "
                                 "not restated here because the arm is an unseeded search and `C6` "
                                 "measured the BAND to be the stable readout) — and "
