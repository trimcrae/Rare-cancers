...
> into the table below: a **new #1 near-term candidate** (ATR-inhibitor synthetic lethality, inherited
> by EMC as a FET-rearranged cancer), a **new all-approved-drug combination** (trabectedin + PPARγ
> agonist on the fusion's own documented PPARG axis), and **two routes closed on their own
> pharmacology** (RXR-heterodimer modulation; 6-mercaptopurine/AF-1 agonism).
...
| **RXR-heterodimer modulation of the fusion** | **✕ CLOSED 2026-08-03, on the receptor's own pharmacology.** NR4A1 and NR4A2 form permissive heterodimers with RXR and RXR ligands modulate them — but **NR4A3 does not heterodimerise with RXR.** The one pharmacology that has actually been solved in this receptor family does not apply to our paralogue. | None. Recorded so it is not re-proposed. |
| **6-mercaptopurine / AF-1 agonism of the fusion** | **✕ CLOSED 2026-08-03, by domain arithmetic already in the repo.** 6-MP is the one approved drug that activates NR4A3 — but it acts **through the AF-1 in the A/B domain, independently of the LBD**, and the AF-1 is exactly the domain EWSR1's low-complexity region replaces in the fusion (NR4A3 AF1 1–260 ↔ EWSR1-LC 1–264, measured in [`manuscripts/target-route-options.md`](./manuscripts/target-route-options.md) check B). **The one approved NR4A3 ligand acts on the half of the protein the disease deletes.** | None. Recorded so it is not re-proposed. |
