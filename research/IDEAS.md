...
| **6-mercaptopurine / AF-1 agonism of the fusion** | **✕ CLOSED 2026-08-03.** 6-MP is the one approved drug that activates NR4A3, but it acts **through the AF-1, independently of the LBD** — and the AF-1 is exactly the domain EWSR1's low-complexity region replaces in the fusion. Reasoning + citation: [`manuscripts/emc-post-degrader-options.md`](./manuscripts/emc-post-degrader-options.md) tier 4. | None. Recorded so it is not re-proposed. |
