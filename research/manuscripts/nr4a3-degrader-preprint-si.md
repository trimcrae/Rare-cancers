...
| **F10** | Medium-high | The de-novo tier was labelled "state-matched" but docks NR4A3 in its unbiased-release frame against biased-metad paralogue frames | Dropped "state-matched" from §2.5; added the receptor-state caveat and noted the mismatch biases **against** NR4A3-selectivity (so a positive call is conservative). **Resolved** |
