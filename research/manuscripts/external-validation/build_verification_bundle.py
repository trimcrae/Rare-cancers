"""Build the first-party verification ZIP from byte-verified, committed source files."""
...
MAPPING = AUDIT / 'verification-bundle-integration.json'
OUTPUT = HERE / 'emc-external-validation-comment-verification.zip'
STAMP = HERE / 'emc-external-validation-comment-verification.build-stamp.json'
...
def main():
    ...
    stamp = {
        ...
        'members': entries,
        'scope': 'First-party verification code and factual results; original sources retrieved separately under their existing terms.'
    }
