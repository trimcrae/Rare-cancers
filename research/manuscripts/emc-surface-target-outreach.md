...
> Goal: obtain the one dataset that converts the surrogate landscape into an EMC-validated result — the
> surface immunophenotype / RNA-seq of the patient-derived EMC lines. Send the day the preprint posts.
> **Tone rule:** collaborative and specific, never presumptuous. We are asking for a favour that benefits
> both sides; lead with respect for their work and offer genuine reciprocity (co-analysis, co-authorship,
> the ready-made computational half). Verify every name/affiliation/citation before sending — placeholders
> are flagged `[VERIFY]`.

## Which groups, and why them

Two groups have established and characterised patient-derived EMC models — the only such reagents in
existence, and the exact missing half of the preprint:

- **USZ group (University Hospital Zurich).** Bangerter et al., *Human Cell* 2022/2023 — models **USZ20-EMC1**
  and **USZ22-EMC2**; ex-vivo drug screening (carfilzomib sensitivity). Data statement: *"available from the
  corresponding author on reasonable request"* — so the ask is literally the request they invited.
  Corresponding author / senior author: `[VERIFY names + email from the paper]`.
- **NCC group (National Cancer Center, Japan; Division of Rare Cancer Research).** Iwata et al., *Human Cell*
  2025 — **NCC-EMC1-C1**; 221-drug screen (brigatinib/panobinostat/romidepsin). Division led by
  **Tadashi Kondo** `[VERIFY]`; first author **S. Iwata** `[VERIFY]`. This group has an extensive
  patient-derived rare-sarcoma cell-line program.

---

## Email 1 — USZ group (Zurich)

**Subject:** EMC surface-antigen map (preprint) — a data request your USZ-EMC models could complete

Dear Dr `[VERIFY surname]`,

I'm writing about your patient-derived extraskeletal myxoid chondrosarcoma models (USZ20-EMC1 / USZ22-EMC2;
...
## Email 2 — NCC group (Japan)

**Subject:** EMC surface-target preprint — could NCC-EMC1-C1 validate our antigen shortlist?

Dear Dr `[VERIFY: Iwata / Kondo]`,

Congratulations on NCC-EMC1-C1 (Iwata et al., *Human Cell* 2025) — establishing a patient-derived EMC line and
