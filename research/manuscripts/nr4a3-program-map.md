...
- **0 of 27 open rows are moving, and 1 of the 27 is now DONE (row 24).** Not one is ◐, and four independent
...
- **12 rows could start today with no authorization and no bench** — **1**, 3, 5, 6, **9 (`R13-a`),
