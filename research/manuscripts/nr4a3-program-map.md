...
| **pmx/GROMACS interface point-mutation ΔΔG** | `V10` → `R7` | the paralogue-scale cross-check `V10` has **not** been benchmarked in | **🔓 AUTHORIZED 2026-08-02 (trimcrae)** — behind its **$0 primary-source precheck** (Open decision 7: a measured mutational value must exist in a primary source before any spend) | 🔓 **authorized, precheck first** |
...
| **12** | **pmx/GROMACS interface point-mutation ΔΔG** | `V10` → `R7` | ○ future | 🔓 **AUTHORIZED**, behind its $0 primary-source precheck | **PROJECTED** | the paralogue-scale regime `V10`'s benchmark does **not** cover. ⚠ [Open decision 10](../../STRATEGY.md#open-decisions): **not an independent second causal line** |
