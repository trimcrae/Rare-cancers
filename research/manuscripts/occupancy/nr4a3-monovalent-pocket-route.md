...
> [`target-route-options.md` route 2](../program/target-route-options.md) frames a C397 molecule as the *targeting
> arm of a bivalent*; [`emc-post-degrader-options.md` route 5](../program/emc-post-degrader-options.md) frames it as a
...
> with this memo, it wins. Also subordinate to [`emc-treatment-strategy.md`](../program/emc-treatment-strategy.md) +
> [`../IDEAS.md`](../../IDEAS.md) (the portfolio) and to [`target-route-options.md`](../program/target-route-options.md)
...
[§0](../program/emc-post-degrader-options.md) owns that finding and its table — and a monovalent molecule discards
...
[`degrader-vs-synthetic-lethal.md`](../dependency/degrader-vs-synthetic-lethal.md) §1 is where the program decided
...
files — [`degrader-vs-synthetic-lethal.md`](../dependency/degrader-vs-synthetic-lethal.md) §1,
[`../IDEAS.md`](../../IDEAS.md), [`emc-treatment-roadmap.md`](../program/emc-treatment-roadmap.md) and
...
[`target-route-options.md`](../program/target-route-options.md)'s reference table already flags that entry as
...
[`degrader-vs-synthetic-lethal.md`](../dependency/degrader-vs-synthetic-lethal.md)) and no known allosteric coupling to
...
taxonomy [`target-route-options.md` §3](../program/target-route-options.md) uses: **RESHAPES.** Three specific ways,
...
[`what-a-civilian-can-buy.md`](../modality-census/what-a-civilian-can-buy.md), which ran the real vendor and construct
...
|---|---|---|---|
| **1** | ✅ **DONE this session — the E3-arm-free reach enumeration** ([`nr4a3_monovalent_reach.py`](../../modalities/nr4a3_monovalent_reach.py)) | §3; closes [`target-route-options.md`](../program/target-route-options.md) $0 item 4 and [`emc-post-degrader-options.md`](../program/emc-post-degrader-options.md) item 4 | it was named twice and never run; a negative was worth as much as a positive and it is the negative |
...
- **The `R4`-purchasability verdict is not this memo's** — [`what-a-civilian-can-buy.md`](../modality-census/what-a-civilian-can-buy.md)
...
- **This memo does not re-rank the portfolio.** [`emc-treatment-strategy.md`](../program/emc-treatment-strategy.md)
...
| **Wansa KDSA, et al.** *The AF-1 domain of the orphan nuclear receptor NOR-1 mediates trans-activation, coactivator recruitment, and activation by the purine anti-metabolite 6-mercaptopurine.* **J Biol Chem** 2003;278(27):24776–90. PMID **12709428** | the AF-1 is where NOR-1's approved-drug pharmacology acts, and SRC-2 modulates AF-1 and not the LBD (§2.3) | [`emc-post-degrader-options.md`](../program/emc-post-degrader-options.md) Tier 4 — quoted verbatim there |
| **Boulay G, et al.** *Cancer-specific retargeting of BAF complexes by a prion-like domain.* **Cell** 2017. doi:10.1016/j.cell.2017.07.036 | the EWSR1 low-complexity region is an independently-acting transactivation/chromatin module (§2.3) | [`degrader-vs-synthetic-lethal.md`](../dependency/degrader-vs-synthetic-lethal.md) |
| **Nabet B, et al.** *The dTAG system for immediate and target-specific protein degradation.* **Nat Chem Biol** 2018. doi:10.1038/s41589-018-0021-8 | the delegated fusion-dependence test, and why it does not serve this route (§2.3) | [`target-route-options.md`](../program/target-route-options.md) references |
| NR4A3 vs EWSR1 domain swap; per-domain paralogue identities | §2.3, §4 | [`target-route-options.md`](../program/target-route-options.md) check B and finding 1 → `target-route-census.json` — **not recomputed here** |
