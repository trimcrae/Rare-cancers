...
> [`nr4a3-monovalent-pocket-route.md` §8](./nr4a3-monovalent-pocket-route.md), which asked the roadmap
...
[the owner memo's §1](./nr4a3-monovalent-pocket-route.md) and it organises this section too, because
...
[§4.2](./nr4a3-monovalent-pocket-route.md#4--effect-on-the-paralogue-requirement--reshapes-into-a-requirement-of-unquantified-size)
...
```json
{
  ...
  "owner": {
    "file": "research/manuscripts/selectivity-requirement-sizing.md",
  ...
  "evidence": [
    "research/manuscripts/selectivity-requirement-sizing.md#22--what-cannot-be-sized-for-this-route-and-the-named-missing-inputs",
    "research/manuscripts/selectivity-requirement-sizing.md#43--req-asym-3--the-defect-a-scalar-creates-stated-so-it-can-be-checked",
...
```json
{
  ...
  "evidence": [
    ...
    "research/manuscripts/selectivity-requirement-sizing.md#31--req-tcip-1--the-induced-interface-floor--cannot-be-sized-today"
  ]
}
```
...
- ⚠ **This document does not re-rank the portfolio and owns no route grade.**
  [`emc-treatment-strategy.md`](./emc-treatment-strategy.md) and
...
| the monovalent route, its two sub-forms, and the E3-arm-free reach result | [`nr4a3-monovalent-pocket-route.md`](./nr4a3-monovalent-pocket-route.md) → [`nr4a3-monovalent-reach.json`](../modalities/nr4a3-monovalent-reach.json) |
