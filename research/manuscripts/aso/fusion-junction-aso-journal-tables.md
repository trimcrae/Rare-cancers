...
*Every cell below is a column of `fusion-junction-aso-sequences.csv`, the canonical machine-readable record. The one thing on this page that is not is the test-article pairing in Table 1's caption, which is a literature fact and carries its source there. Every reagent named here is a 5-6-5 phosphorothioate gapmer. An oligonucleotide should be ordered from that file rather than transcribed from this page.*
...
| seam | reagent | margin | WT gap duplex (bp) | ΔTm floor (°C) |
|---|---|---:|---|---:|
