...
⛔ **29 deposited paths differ** from the published record: **28 changed, 1 added, 0 removed** against its own manifest at `4fd4698daec0`.
...
* `research/manuscripts/build_submission_pdf.py`
