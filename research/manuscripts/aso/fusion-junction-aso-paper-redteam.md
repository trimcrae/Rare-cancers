---
id: DOC-FUSION-JUNCTION-ASO-PAPER-REDTEAM
title: Red-team of the fusion-junction ASO paper — deficiencies + fixes applied
level: L3
kind: manuscript
status: live
canonical_for: []
...
[`novel-modalities.md`](../modality-census/novel-modalities.md) §3.3 resolves EWSR1 exons 7/9/10/11/12/13 → NR4A3 exon 3 from
