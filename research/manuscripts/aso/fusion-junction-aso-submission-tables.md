...
| design | junction | GC (%) | gap-level margin | ΔΔG°37 (kcal/mol) | near-matches, either strand | of those, hybridisable | exact / ≤1-mismatch matches | residual cleavage load, both bounds³ | conventional rules failed⁴ | at the deeper ceiling: near-matches / hybridisable / gap-spanning loci | survives⁵ |
|---|---|---|---|---|---|---|---|---|---|---|---|
