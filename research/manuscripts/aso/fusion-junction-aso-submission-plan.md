...
| numbered tables | ✅ generated; the count is measured in the same artifact and is not stated here. Table 3 lists the designs the cleanliness claim is about — added 2026-08-13, because that claim had no table and only four of its nine molecules appeared anywhere in Table 2 (⚠ *superseded, retained: "✅ three, generated" — tables were added after it and the row went on reading as a current count*) | **none exist** |
