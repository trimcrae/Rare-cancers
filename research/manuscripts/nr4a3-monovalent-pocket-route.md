...
| **3** | **Resolve "Munck 2022" → Zaienne 2022 across the four files that carry it**, through `verify-refs` | citation integrity (§2.2) | a wrong author name on the paper the whole warhead lane is anchored to. Not fixed here because it spans four files outside this memo's scope |
| **4** | **Re-fetch PMC9542104 in CI and re-confirm the Gal4-NOR-1-LBD construct verbatim** | §2.3, which is now load-bearing | the repo's verbatim verification is dated 2026-07-12 and stands; the dev sandbox's proxy 403s PMC, so re-reading the source is a runner job (CLAUDE.md §6) — and §2.3 is now carrying more weight than it was when first recorded |
...
|---|---|---|
| **Zaienne D, Arifi S, Marschner JA, Heering J.** *Druggability Evaluation of the Neuron Derived Orphan Receptor (NOR-1) Reveals Inverse NOR-1 Agonists.* **ChemMedChem** 2022;17(16):e202200259. PMID **35704774**, PMC9542104, doi 10.1002/cmdc.202200259 | LBD-borne functional modulation of NOR-1; the Gal4-NOR-1-LBD readout; the absent paralogue counter-screen (§2.2, §2.3) | [`nr4a3-druggability-reconciliation.md`](../modalities/nr4a3-druggability-reconciliation.md) — primary-source verified 2026-07-05, counter-screen absence verified verbatim 2026-07-12. ⚠ **Cited as "Munck 2022" in four other repo files with no PMID — see §2.2 and backlog item 3** |
