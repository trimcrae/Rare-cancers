...
([`nr4a3-degrader-paper.md`](../degrader/nr4a3-degrader-paper.md)) recruits the **NR4A3 LBD** — the ordered domain
...
covered in [`novel-modalities.md`](../modality-census/novel-modalities.md) §3.2–3.3 and the roadmap; this paper develops the
...
- DepMap 24Q4 transfer-prior analysis downgrading the synthetic-lethal BRD9/ncBAF route (BRD9 not a sarcoma
  ...
  [`emc-treatment-strategy.md`](../program/emc-treatment-strategy.md), [`../IDEAS.md`](../../IDEAS.md),
...
- LBD-shared selectivity gap of the NR4A3 degrader (contrast partner for this paper):
  [`nr4a3-degrader-paper.md`](../degrader/nr4a3-degrader-paper.md).
