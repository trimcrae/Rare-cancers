...
> **QA / FACT-CHECK LOG (not a manuscript)** for [`repurposing-hypotheses.md`](../repurposing/repurposing-hypotheses.md).
> Active manuscript: [`emc-treatment-roadmap.md`](../program/emc-treatment-roadmap.md). Folder map: [`README.md`](../README.md).
