...
> [`emc-post-degrader-options.md`](./emc-post-degrader-options.md) and
> [`target-route-options.md`](./target-route-options.md). Where any of them conflicts with this paper
...
2. **Closures are the cheapest deliverable a computation-only program has.** Every route here was
   ...
   not decay ([`emc-post-degrader-options.md` §2, Tier 4](./emc-post-degrader-options.md#2--the-ranked-list)).
...
[`target-route-options.md` route 12](./target-route-options.md). The artifact's own limits are
...
([`emc-post-degrader-options.md` route 14](./emc-post-degrader-options.md#route-14---the-fusion-driven-synthetic-promoter-and-the-precise-reason-emc-is-a-harder-case-than-ewing)
...
[`emc-post-degrader-options.md`](./emc-post-degrader-options.md) routes 14 and 15 and are not
re-listed here.
