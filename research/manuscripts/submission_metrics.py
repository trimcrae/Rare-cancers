...
VENUES = {
    "bioRxiv-preprint": {
        "journal": "bioRxiv (DECLINED 2026-08-23, author unaffiliated; the journal submission of the condensed article goes to Nucleic Acid Therapeutics)",
        ...
        "provenance": ("VERIFIED at primary source: bioRxiv sets no word, abstract or display-item "
                       ...
                       "read rather than searched. ⛔ AND bioRxiv DECLINED THIS SUBMISSION ON "
                       "2026-08-23 BECAUSE THE AUTHOR IS UNAFFILIATED, so this row grades a "
                       "manuscript against a server that will not take it. The limits stay correct "
                       "and the row stays ungated for that reason — the extended report is "
                       "archived on Zenodo and has since been submitted elsewhere — but nobody "
                       "should read the row name as a live plan. Accounting: "
                       "aso/fusion-junction-aso-preprint-checklist.md §2 step 3. ⚠ ALL-`None` IS A STATEMENT, NOT A GAP: it means "
