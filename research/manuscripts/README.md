...
> 1. **[`nr4a3-degrader-paper.md`](./degrader/nr4a3-degrader-paper.md)** — **lead result paper**; **reframed
...
>
> **Next tier (not the first two):** **[`emc-treatment-roadmap.md`](./program/emc-treatment-roadmap.md)** (the
> EMC-program paper: driver-directed framework, categorical-gap landscape, fusion-specific routes) and the
> **fusion-exclusivity framework** ([`fusion-selective-approaches-overview.md`](./fusion-direct/fusion-selective-approaches-overview.md))
...
> [`nr4a3-degrader-paper-positioning.md`](./degrader/nr4a3-degrader-paper-positioning.md)). Everything else in this
...
- **[`emc-treatment-roadmap.md`](./program/emc-treatment-roadmap.md)** — *"Attacking an 'undruggable' fusion
...
- **[`emc-treatment-strategy.md`](./program/emc-treatment-strategy.md)** — the capstone that ranks every
...
- [`immunotherapy-options-emc.md`](./neoantigen/immunotherapy-options-emc.md) — TCR-T / ICI / ImmTAC (Phase 1)
- [`emerging-modalities-scan-emc.md`](./modality-census/emerging-modalities-scan-emc.md) — trabectedin, FAP-RLT, PPARG (Phase 2)
- [`car-t-strategies-emc.md`](./surface-targets/car-t-strategies-emc.md) — CAR-T *surface-target* strategies for treating EMC directly (Phase 3). NB: distinct from the degrader's pan-NR4A CAR-T-*enhancement* angle below.
- [`nr4a3-degrader-carT-and-family-druggability-framing.md`](./degrader/nr4a3-degrader-carT-and-family-druggability-framing.md) — framing decision (2026-07-08): the pan-NR4A ex-vivo CAR-T-enhancement pole + the NR4A-family-druggability reframe (JCIM target; NCS walked back). Feeds the degrader paper + positioning doc.
- [`nr4a3-degrader-ncs-presubmission-inquiry.md`](./degrader/nr4a3-degrader-ncs-presubmission-inquiry.md) — drafted free presubmission enquiry to Nature Computational Science (the long shot); if declined → JCIM + ChemRxiv.
- [`degrader-vs-synthetic-lethal.md`](./dependency/degrader-vs-synthetic-lethal.md) — degrader vs. BRD9 head-to-head
- [`target-route-options.md`](./program/target-route-options.md) — **the TARGET axis (2026-08-02): must the molecule be NR4A-paralogue-selective at all, and against what?** Ranks 13 routes by their *effect on the selectivity requirement* (removes / reshapes / relocates) and grades each against the roadmap's failure record. Headline: the requirement does not dissolve — the NR4A1+NR4A3 pair is the named AML anti-target — but it is **asymmetric**, and the four routes that remove it all do so by leaving the free-energy axis entirely. Also records a $0 finding with wide reach: **the repo holds two incompatible models of the fusion protein**, so requirement `R13`'s object is undefined. Numbers: [`../modalities/target-route-census.json`](../modalities/target-route-census.json)
- [`nr4a3-degrader-broader-indications.md`](./degrader/nr4a3-degrader-broader-indications.md) — beyond-EMC motivation for the degrader (NR4A3-fusion sarcomas; NR4A in T-cell exhaustion / immuno-oncology; the AML tumour-suppressor contraindication)

## Surface-antigen preprint (red-teamed; hypothesis-generating, seeks validation data)

- [`emc-surface-target-landscape.md`](./surface-targets/emc-surface-target-landscape.md) — **full preprint** (trimcrae
  ...
  self-critical after two red-team passes ([`emc-surface-target-redteam.md`](./surface-targets/emc-surface-target-redteam.md)):
  ...
  **SSTR2/GD2** route rather than declaring winners. ⛔ **Materially amended 2026-08-05
  ([Amendment 1](./surface-targets/emc-surface-target-landscape.md)): the DepMap line it called "the one real EMC line" is
  ...
  Ready-to-send author outreach: [`emc-surface-target-outreach.md`](./surface-targets/emc-surface-target-outreach.md).
  Makes **no** EMC-validated surface claim; the decisive protein-level validation needs the patient-derived
  EMC lines.

- [`emc-post-degrader-options.md`](./program/emc-post-degrader-options.md) — **decision memo** (trimcrae, 2026-08-03):
  ...
  **fusion-junction ASO** (held #2), and the **in-silico ATR vulnerability assessment** (#3); the ATR **cell
  ...
  corpus is [`lit-targets-emc-post-degrader.json`](./program/lit-targets-emc-post-degrader.json) on `literature-cache`.
...
- [`repurposing-hypotheses.md`](./repurposing/repurposing-hypotheses.md) — mechanism-based repurposing catalog
- [`novel-modalities.md`](./modality-census/novel-modalities.md) — structure-based target assessment + neoantigen pipeline
- [`clinical-brief-emc-neoantigen.md`](./neoantigen/clinical-brief-emc-neoantigen.md) — one-page clinician brief derived from novel-modalities

## Parked

- [`hla-coverage-emc.md`](./neoantigen/hla-coverage-emc.md) — fusion-neoantigen HLA-coverage analysis. **Parked**
...
- [`meta-analysis.md`](./endpoint/meta-analysis.md) — pooled **outcomes** systematic review / meta-analysis
...
- [`fact-check-log.md`](./methods-record/fact-check-log.md) — fact-check trail for `repurposing-hypotheses.md`
- [`repurposing-hypotheses-review.md`](./repurposing/repurposing-hypotheses-review.md) — internal peer-review pass of the same
- [`novel-modalities-factcheck.md`](./modality-census/novel-modalities-factcheck.md) — fact-check trail for `novel-modalities.md`
- [`emc-treatment-paper-outline.md`](./program/emc-treatment-paper-outline.md) — the retired planning scaffold for the
