...
⇒ The sign question [`selectivity-requirement-sizing.md` §3.1](../degrader/selectivity-requirement-sizing.md)
...
1. ⛔ **`REQ-TCIP-2` stays the operative requirement.** Every geometric statement the route publishes
   ...
   [`selectivity-requirement-sizing.md`](../degrader/selectivity-requirement-sizing.md) and the roadmap, routed
