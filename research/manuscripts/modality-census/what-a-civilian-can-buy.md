...
> [`emc-treatment-strategy.md`](../program/emc-treatment-strategy.md) + [`../IDEAS.md`](../../IDEAS.md) (the route
...
1. **Already known here:** it succeeded. A fragment library screen, hit rate <1 %, returned three
   ...
   *"leave the binding site **structurally undefined**"*
   ([paper §1](../degrader/nr4a3-degrader-paper.md); [roadmap §5 row R4](../nr4a3-program-map.md#5--where-each-requirement-stands)).
...
its numbering onto the UniProt frame by an **exact +378 offset** — [paper §2.1](../degrader/nr4a3-degrader-paper.md).)*
...
### 2.1 · From [`emc-post-degrader-options.md`](../program/emc-post-degrader-options.md)
...
1. ⭑ **The repo's two levers are the right two levers, and this memo is the audit that closes the
   question.** [`emc-treatment-strategy.md`](../program/emc-treatment-strategy.md)'s *"two paths"* —
