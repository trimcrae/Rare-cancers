---
id: DOC-NR4A3-DEGRADER-PAPER-SI
title: Supporting Information — In silico design of a paralogue-favoured ligand for a cryptic NR4A3 pocket
level: L3
kind: manuscript
status: live
canonical_for: []
...
EMC-program paper ([`emc-treatment-roadmap.md`](../program/emc-treatment-roadmap.md)); **this paper's claimed contribution
