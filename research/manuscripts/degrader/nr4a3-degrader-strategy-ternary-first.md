...
> [nr4a3-program-map.md](../nr4a3-program-map.md)** (the master ordered plan) and
...
**[SUPERSEDED as the selection method 2026-07-15 — see the top banner + [`/nr4a3-program-map.md`](../nr4a3-program-map.md)
...
(cf. [`fusion-selective-approaches-overview.md`](../fusion-direct/fusion-selective-approaches-overview.md)).
...
- Three-level framework + 5-route fusion-exclusive comparison (ranked by likelihood-of-working; leads with the
  ASO) → [`fusion-selective-approaches-overview.md`](../fusion-direct/fusion-selective-approaches-overview.md).
...
- The **sequence-clean** fusion-exclusive alternative *modality* (junction ASO/siRNA — fusion-exclusive by
  ...
  [`fusion-junction-aso-working-record.md`](../aso/fusion-junction-aso-working-record.md).
...
[degrader-paper-schedule.json](../program/degrader-paper-schedule.json). **denovo_401 → side comparator only.** The
