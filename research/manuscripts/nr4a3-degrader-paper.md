...
**+8.27 ± 0.50** (NR4A2) → ΔΔG(NR4A3 − NR4A1) = **−6.7** and ΔΔG(NR4A3 − NR4A2) = **−5.4** kcal/mol (both favour NR4A3; the
NR4A2 leg's reduction required the robust MBAR solver on marginal window overlap). Every
