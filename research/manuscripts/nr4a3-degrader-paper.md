...
pocket, and the MM-GBSA noise floor of §2.6–2.6). The full selectivity-architecture analysis — the
...
never trimmed) — justified by the structural-sanity control (§2.3: fold intact, core RMSD 1.76 Å) and standard
