...
| **AF3 on a druggable interface** | `RT-AF3-INTERFACE` | Deferred; method not strategy | [`IDEAS.md`](../IDEAS.md#route-board) | — |
...
| **FAP-targeted radioligand therapy (FAPI-RLT)** | `RT-FAP-RLT` | Emerging, plausible | [`emerging-modalities-scan-emc.md`](emerging-modalities-scan-emc.md#2) | [`IDEAS.md`](../IDEAS.md) |
...
| **Checkpoint inhibitor + anti-angiogenic TKI combination** | `RT-ICI-TKI` | TOP NEAR-TERM LEAD (best EMC evidence) | [`immunotherapy-options-emc.md`](immunotherapy-options-emc.md#2) | [`IDEAS.md`](../IDEAS.md) |
...
| **PRAME-directed brenetafusp (ImmTAC) / PRAME CAR-TCR** | `RT-PRAME-IMMTAC` | NEW antigen-directed lead — best of the CTAs | [`IDEAS.md`](../IDEAS.md#route-board) | [`immunotherapy-options-emc.md`](immunotherapy-options-emc.md) |
...
| **Trabectedin (± RT or combination)** | `RT-TRABECTEDIN` | NEAR-TERM LEAD — approved, mechanism-fit | [`IDEAS.md`](../IDEAS.md#route-board) | [`emerging-modalities-scan-emc.md`](emerging-modalities-scan-emc.md) |
| **Trabectedin + a PPARγ agonist (all approved drugs)** | `RT-TRABECTEDIN-PPARG` | Tier 2, rank 5 — ASK with a good taker and a thin deliverable | [`emc-post-degrader-options.md`](emc-post-degrader-options.md#route-6--trabectedin--a-ppar-agonist-an-all-approved-drug-combination-on-emcs-own-documented-axis) | [`IDEAS.md`](../IDEAS.md) |
