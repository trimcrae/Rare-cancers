...
| `RT-SYNPROMOTER` Fusion-driven synthetic promoter → suicide gene | premise_false | no | `TR-OLIGO-TUMOUR-DELIVERY` | `RT-ASO`, `RT-ASO-ASK` |
...
| `RT-CRISPR-CAS13` CRISPR/Cas9 intron-targeted fusion disruption; Cas13 fusion-RNA knockd | instrument_limit | no | `TR-OLIGO-TUMOUR-DELIVERY` | `RT-ASO`, `RT-ASO-ASK` |
...
| `RT-RIBOZYME` Trans-splicing ribozyme → suicide gene, triggered by the fusion transc | instrument_limit | no | `TR-OLIGO-TUMOUR-DELIVERY` | `RT-ASO`, `RT-ASO-ASK` |
