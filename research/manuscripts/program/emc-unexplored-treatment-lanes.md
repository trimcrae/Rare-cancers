...
> [`fet-fusion-trial-eligibility-notice.md`](../fusion-direct/fet-fusion-trial-eligibility-notice.md), data in
...
> [`hybrid-intron-aso-target.md`](../aso/hybrid-intron-aso-target.md) →
...
correction is
[`emc-surface-target-landscape.md` → Amendment 1](../surface-targets/emc-surface-target-landscape.md), and this memo
...
1. ✅ **CLOSED 2026-08-07 — `RT-ICI-TKI`'s evidence is out of date, and the missing effect size has now
   ...
   [`emc-systemic-therapy-pooling.json`](../endpoint/emc-systemic-therapy-pooling.json) → `retrieval_provenance`.
