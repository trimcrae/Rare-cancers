SOURCE URL: https://raw.githubusercontent.com/ArcInstitute/state/main/README.md
FINAL URL: https://raw.githubusercontent.com/ArcInstitute/state/main/README.md
HTTP: 200
...
- `data.kwargs.downsample` downsample counts during loading (` 1` targets that read depth per cell for `output_space=all`).
